...
# Add path to directory containing 'my_illustris_python' module
#    e.g. if this file is in '/n/home00/lkelley/illustris/my_illustris_python/tests/'
...
import my_illustris_python as ill
